...
indirect enum Object {
    ...
    case Error(message: String, line: Int, function: String, file: String)
    /// Fatal error are used to identify bugs in code.
    case FatalError(message: String, line: Int, function: String, file: String)
...
class SchemeSymbol: Hashable {
    ...
    public static func == (lhs: SchemeSymbol, rhs: SchemeSymbol) -> Bool {
        return lhs.characters == rhs.characters && lhs.length == rhs.length
    }
